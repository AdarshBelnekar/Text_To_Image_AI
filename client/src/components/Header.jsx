  ...
  return (
    < motion.div className='flex flex-col justify-center items-center text-center my-20'
      ...
      >
       ...
       > Create your own creativity with AI. Turn  your imagination into visual art in seconds -just type,and watch the magic happens.</motion.p>
       ...
       < motion.p className='mt-2 text-netural-600'
          initial={{opacity:0}}
          animate={{opacity:1}}
